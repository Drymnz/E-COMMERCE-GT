...
export class SancionResponse {
  ...
  /** Getters */
  get sanciones(): Sancion[] {
    return this._sanciones;
  }

  get totalSanciones(): number {
    return this._totalSanciones;
  }
  ...
  /** Setters */
  set sanciones(valor: Sancion[]) {
    this._sanciones = valor;
  }

  set totalSanciones(valor: number) {
    this._totalSanciones = valor;
  }
  ...
  set paginaActual(valor: number) {
    this._paginaActual = valor;
  }

  // Crea una instancia de SancionResponse desde datos
