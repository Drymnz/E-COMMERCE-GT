...
import { PagoComponent } from './pags/customer/manage-shopping-cart/pago/pago.component';
...
export const routes: Routes = [
  // RUTAS ADMIN (rol 4)
  { path: 'ventas', canActivate: [roleGuard(['4'])], component: VentasComponent },
  { path: 'admin', canActivate: [roleGuard(['4'])], component: AdminComponent },
  { path: 'report', canActivate: [roleGuard(['4'])], component: ReportComponent },
  { path: 'notificacion', canActivate: [roleGuard(['4'])], component: NotificacionesComponent },
  { path: 'historial-empleados', canActivate: [roleGuard(['4'])], component: HistorialEmpleadosComponent },
  
  // RUTAS CLIENTE (rol 1)
  { path: 'gestion-tarjetas', canActivate: [roleGuard(['1'])], component: GestionTarjetasComponent },
  { path: 'manage-products-sale', canActivate: [roleGuard(['1'])], component: ManageProductsSaleComponent },
  { path: 'register-article', canActivate: [roleGuard(['1'])], component: RegisterArticleComponent },
  { path: 'register-article/:id', canActivate: [roleGuard(['1'])], component: RegisterArticleComponent },
  { path: 'manage-shopping-cart', canActivate: [roleGuard(['1'])], component: ManageShoppingCartComponent },
  { path: 'payment-manager', canActivate: [roleGuard(['1'])], component: PagoComponent },
  { path: 'order-tracking', canActivate: [roleGuard(['1'])], component: OrderTrackingComponent },
  
  // RUTAS MODERADOR (rol 2)
  { path: 'panel-moderator', canActivate: [roleGuard(['2'])], component: PanelModeracionComponent },
  { path: 'lits-usuario', canActivate: [roleGuard(['2'])], component: UsuariosListComponent },
  { path: 'lits-sanctions', canActivate: [roleGuard(['2','4'])], component: ListSanctionsComponent },
  
  // RUTAS LOGÍSTICA (rol 3)
  { path: 'order-management', canActivate: [roleGuard(['3'])], component: OrderManagementComponent },
